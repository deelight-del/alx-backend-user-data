...
print("Expect True", a.require_auth("/api/v1/users", ["/api/v1/stat*"]))
print("Expect False", a.require_auth("/api/v1/status", ["/api/v1/stat*"]))
print("Expect False", a.require_auth("/api/v1/stats", ["/api/v1/stat*"]))
print("Expect False", a.require_auth("/api/v1/stat", ["/api/v1/stat*"]))
print("Expect True", a.require_auth("/api/v1/sta/", ["/api/v1/stat*"]))
